...
class CfgVemfReloaded
	{
		...
		debugMode = 1; // 0 = no debugging | 1 = ERRORS only | 2 = INFO only | 3 = ERRORS & INFO
		...
		class Exile // Exile specific settings
			{
				...
				aiMoney = 500; // (max) amount of money that AI will have on them
				crateMoney = 2000; // (max) amount of money in the loot crate
				respectReward = 50; // 0 = no respect for killing AI | respectReward > 0 = amount of minimum respect reward for player
